...
def banner():
	clear()
	wel='# BUKAN CUCU SAMSUDIN HAHAH'
	cik2=mark(wel ,style='cyan')
	sol().print(cik2)
	ban='''
•   AUTHOR  : KANG RECODE LU KAMPRET 

 ___________  ____  ____   _______   ____  ____  
("     _   ")("  _||_ " | /"      \ ("  _||_ " | 
 )__/  \\__/ |   (  ) : ||:        ||   (  ) : | 
    \\_ /    (:  |  | . )|_____/   )(:  |  | . ) 
    |.  |     \\ \__/ //  //      /  \\ \__/ //  
    \:  |     /\\ __ //\ |:  __   \  /\\ __ //\  
     \__|    (__________)|__|  \___)(__________) 
                                                 
•   GITHUB : kAGA PUNYA GUA KONTOL •'''
